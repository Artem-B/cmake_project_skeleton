...
// configuration step. It creates a namespace called `cmake_project_skeleton`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_project_skeleton::cmake::project_name, cmake_project_skeleton::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_project_skeleton::cmake::project_version);
      return EXIT_SUCCESS;
    }
